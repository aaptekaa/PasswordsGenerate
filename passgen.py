...
""" + colorama.Fore.CYAN + "\n                           by @KaliSecurityMax \n             github.com/KaliSecurityMax/PasswordsGenerate \n ----------------------------------------------------------------------\n\n")
class List:
...
class PassGen:
    ...
    def get_input(self):
        while self.is_alive:
            print(
                'Введите ключевые слова, имя, пароль, номер, символ или дату рождения(мм-дд-гггг)')
            print('Чтобы закончить и получить список паролей введите - maxgenerate')
            ...
            if user_input.lower() != 'maxgenerate':
    ...
    def generate(self):
        print('Создание списка началось. Ожидайте... ')
        ...
        with open('passwords.txt', 'wt', encoding='utf-8') as output_file:
            ...
            print(
                f'Список паролей успешно создан. Создано паролей: {len(self.password_list)}')
